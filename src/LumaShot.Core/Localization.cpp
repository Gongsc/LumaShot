...
constexpr std::array entries{
    ...
    Entry{StringId::Hotkey, L"快捷键", L"Hotkey"}, Entry{StringId::IncludeCursor, L"包含鼠标指针", L"Include mouse pointer"}, Entry{StringId::LaunchAtLogin, L"开机启动", L"Start at sign-in"},
    ...
    Entry{StringId::HdrCalibrationHint, L"影响截图预览、PNG 与剪贴板，不改变 HDR JPEG XR", L"Affects preview, PNG, and clipboard; HDR JPEG XR stays unchanged"},
    ...
    Entry{StringId::LivePreview, L"实时预览", L"Live preview"},
